...
<div class="main main-raised">
    <div class="container">
        ...
        <div class="section landing-section">
            <h2 align="center">Resgitro de nuevos productos</h2>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group label-floating">
                            ...
                            <input type="text" class="form-control" name="kind_product" value="{{old('kind_product')}}">
                    </div>
                   ...
                   <textarea class="form-control" placeholder="Descripcion extensa" rows="5" name="log_description" value="{{old('log_description')}}">
                   </textarea>
