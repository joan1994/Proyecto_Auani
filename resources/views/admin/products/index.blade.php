@extends('layouts.app')
@section('title','listado de prodictos')
                    ...
                    <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="col-md-2 text-center">Tipo de Producto</th>
                                ...
                                <tr>
                                    ...
                                    <td class="td-actions text-right">
                                        ...
                                        <form method="post" action="{{ url('/admin/products/'.$product->id)}}">
                                            ...
                                            <a href="{{ url('/admin/products/'.$product->id.'/images') }}" rel="tooltip" title="Imagen del producto" class="btn btn-warning btn-simple btn-xs">
